...
public class HashTabDemo {
    ...
    public static void main(String[] args) {
        ...
        //创建哈希表
        HashTab1 hashTab = new HashTab1(7);
...
class HashTab1 {
    ...
    public void findEmpById(int id) {
        ...
        Emp1 emp = empLinkedListArray[empLinkedListNO].findEmpById(id);
        if(emp != null) {//找到
...
class Emp1 {
    public int id;
    public String name;
    public Emp1 next; //next 默认为 null
...
class EmpLinkedList1 {
    ...
    public Emp1 findEmpById(int id) {
        //判断链表是否为空
        if(head == null) {
